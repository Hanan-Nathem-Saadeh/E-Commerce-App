...
{
    public abstract class DemoData : IDisposable
    {
        ...
        public DemoData()
        {
            ...
            _db = new FastMarketDBContext(new DbContextOptionsBuilder<FastMarketDBContext>().UseSqlServer(_connection).Options);
